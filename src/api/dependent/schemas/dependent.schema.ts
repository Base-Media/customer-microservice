...
@ObjectType()
@Schema({ timestamps: true, collection: 'dependents' })
...
DependentSchema.set('toJSON', { getters: true });
DependentSchema.set('toObject', { getters: true });
export type DependentDocument = Dependent & Document;